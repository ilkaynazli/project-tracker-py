...
def get_project_by_title(title):
    ...
    row = db_cursor.fetchone()
    print("Here is the name of the project: {}" .format(row[0]))
...
def get_grade_by_github_title(github, title):
    ...
    row = db_cursor.fetchone()
    print("{} has got {} from the project named {}." 
...
def assign_grade(github, title, grade):
    ...
    db.session.commit()
    print("Successfully added student's grade:")
    print("{} got {} from project {}" .format(github, grade, title))
